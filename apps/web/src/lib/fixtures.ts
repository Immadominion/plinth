...
const APPLICATIONS = listOf([
  { id: 'app_1', business_name: 'Naija Streams',   contact_name: 'Ify Okoro',  email: 'ify@naijastreams.com',  status: 'pending',  rc_number: 'RC1234567', website: 'https://naijastreams.com', description: 'A Nollywood streaming service.', nomba_sub_account_id: '',            created_at: iso(-1),  reviewed_at: null,      tenant_id: null,        rejection_reason: null },
  { id: 'app_2', business_name: 'FitClub NG',      contact_name: 'Sola Ade',   email: 'sola@fitclub.ng',       status: 'approved', rc_number: 'RC7654321', website: 'https://fitclub.ng',       description: 'Gym membership subscriptions.', nomba_sub_account_id: 'sub_acc_9f2', created_at: iso(-10), reviewed_at: iso(-9),   tenant_id: 'ten_fitclub', rejection_reason: null },
  { id: 'app_3', business_name: 'ShadyDeals',      contact_name: 'John Doe',   email: 'john@shady.co',         status: 'rejected', rc_number: '',          website: '',                          description: 'Unclear business model.',       nomba_sub_account_id: '',            created_at: iso(-20), reviewed_at: iso(-19),  tenant_id: null,        rejection_reason: 'Insufficient business information provided.' },
]);
